...
-(void)layoutView
{
    ...
    _tabbarView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"selfiefooter_0"]];
    [_tabbarView setFrame:CGRectMake(0, -180, screenWidth, 200)];
...
-(void)btn1Click:(id)sender
{
    ...
    switch (btn.tag) {
        case 101:
        {
            [_tabbarView setImage:[UIImage imageNamed:@"selfiefooter_0"]];
